...
- Никогда не публикуйте реальные ключи (api.encryption, ota password, wifi пароли) в публичных репозиториях.
- После публикации публичного конфига смените ключи, если вы ранее использовали те же значения на работающем устройстве.
- Для доступа к устройству по OTA держите устройство в локальной сети и используйте сильный пароль.
